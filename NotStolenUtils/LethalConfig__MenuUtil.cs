...
namespace GamemodeManager.NotStolenUtils
{
    internal class LethalConfig__MenuUtil
    {
        internal static void InjectMenu(Transform parentTransform, Transform mainButtonsTransform, Object quitButton, string text, UnityAction onClick)
        {
            ...
            clonedButton.GetComponent<Button>().onClick.AddListener(onClick);

            clonedButton.GetComponentInChildren<TextMeshProUGUI>().text = "> " + text;
